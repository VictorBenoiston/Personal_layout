...
<h1>English: </h1>
<div>Singlepage layout where i rematched a curriculum, but a bit more interactive wih active links and hosted on web. Also, make available the kernel code from the page here, at github. Site hosted on firebase</div>
